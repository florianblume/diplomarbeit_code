...
class SubUNet(AbstractUNet):
    """Subnetwork that the main (=averaging) network uses. This network simply
    predicts the denoised image, similarly to the baseline.
    """
    ...
    def _build_network_head(self, outs):
        # NOTE 1 should actually be num_channels x num_classes, to account for
        # RGB images and Probabilistic Noise2Void
