...
python src/train_model.py experiments/baseline/main_2/n2c/joined/simsim/raw_all_even/config.yml
#python src/train_model.py experiments/baseline/main_2/n2c/fish/avg16/config.yml
python src/train_model.py experiments/baseline/main_2/n2c/fish/raw/config.yml
...
python src/train_model.py experiments/average/main_2_sub_2/n2c/fish_simsim/raw_all/image_even/config.yml
python src/train_model.py experiments/average/main_2_sub_2/n2c/fish_simsim/raw_all/pixel_even/config.yml
