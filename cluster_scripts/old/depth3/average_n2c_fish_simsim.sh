...
python src/train_model.py experiments/average/main_3_sub_3/n2c/fish_simsim/raw_all/image_even_weight_multiplier/config.yml
...
#python src/train_model.py experiments/average/main_3_sub_3/n2c/fish_simsim/raw_all/pixel_even_weight_multiplier/config.yml
